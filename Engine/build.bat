...
set include_paths= /I..\Engine\src /I%VULKAN_SDK%\include /I..\ThirdParty /I..\ThirdParty\glfw\include /I..\ThirdParty\imgui
...
pushd ..\bin
cl /EHsc /WX /Zi /std:c++17 %include_paths% /DDEBUG /c %SOURCES% ..\ThirdParty\VulkanBootstrap\*cpp  ..\ThirdParty\imgui\*cpp /link C:\VulkanSDK\1.3.250.1\Lib\vulkan-1.lib ..\ThirdParty\glfw\lib-vc2022\glfw3.lib
